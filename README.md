...
See [ASPNET_INTEGRATION_GUIDE.md](./ASPNET_INTEGRATION_GUIDE.md) for a step-by-step guide to implementing the same embed in an **ASP.NET Core / Razor Pages** application.
